...
'''
Columns of the Finan_payment data frame

Index(['APPLICATION_USER_ID', 'F_CREACION_CONTRATO', 'CUPO', 'START_DATE',
       'CUT_OFF_DATE', 'PAYMENT_DATE', 'ESTADO', 'ESTADO_OPERATIVO',
       'NUM_RECIBOS_IMPAGOS', 'PAGO_MINIMO', 'SALDO_TOTAL', 'CAYO_EN_IMPAGO',
       'BC_SCORE', 'ESTIMATED_INCOME', 'TAX_RATE', 'HUBO_AUMENTO',
       'VALOR_AUMENTO', 'ESTADO_PROPUESTA', 'TOTAL_CONSUMO', 'PAYMENT'],
      dtype='object')
'''
