...
In this case only financial features were used.
'''
import pandas as pd
import numpy as np
import pickle 
...
X = X.iloc[:, np.r_[0:17]]
y = data['Type_balance']
print(f'These are the financial features: {X.info()}')
...
'''Decision Trees, XGB and Random Forest are going to be trained, also hyperparameter search is performed'''
...
# Now definition of the grid search
# Here as evaluation metric it will be used f1 weighted measure.
